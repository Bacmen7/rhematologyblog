        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 mb-16 md:mb-20">
          ...
          <div className="flex items-end">
            <p style={{ fontSize: "18px", lineHeight: 1.67, letterSpacing: "0.4px", color: "#b0b5c0" }}>
              ...
              <strong className="font-semibold" style={{ color: "#182439", background: "#feccbc", padding: "2px 6px", borderRadius: "3px" }}>hundreds of rheumatic conditions</strong>.
            </p>
          </div>
        </div>
