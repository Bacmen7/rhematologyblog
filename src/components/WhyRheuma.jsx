...
function WhyRheuma() {
  return (
    <section className="custom-approach-section relative bg-[#0f616e] pt-[100px] pb-[130px] md:pt-[120px] md:pb-[150px] text-white overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 mb-16 md:mb-20">
          ...
          <div className="flex items-end">
            <p style={{ fontSize: "18px", lineHeight: 1.67, letterSpacing: "0.4px", color: "#9a9faa" }}>
              ...
              <strong className="font-semibold" style={{ color: "#ffffff", background: "#fa885a", padding: "2px 6px", borderRadius: "3px" }}>hundreds of rheumatic conditions</strong>.
            </p>
          </div>
        </div>
