    ...
    <section className="max-w-7xl mx-auto px-6">
      <div className="pt-16 pb-24 grid lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-3">
          ...
          <h3 className="font-display text-3xl leading-tight">JAK Inhibitor Market Dynamics</h3>
        </div>
        ...
        <div className="lg:col-span-4 bg-navy-deep text-white p-8 rounded-sm">
          ...
          <ul className="space-y-6">
            <li className="flex gap-4">
              <span className="text-primary font-display italic text-2xl leading-none">01</span>
            ...
            <li className="flex gap-4">
              <span className="text-primary font-display italic text-2xl leading-none">02</span>
