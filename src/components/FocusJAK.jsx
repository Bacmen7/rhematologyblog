function FocusJAK() {
  return (
    <section className="max-w-7xl mx-auto px-6">
      <div className="border-t border-navy-deep/5 pt-16 pb-24 grid lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-3">
          <h2 className="text-xs uppercase tracking-[0.3em] font-bold text-primary mb-4">Focus 01</h2>
          <h3 className="font-serif text-3xl leading-tight">JAK Inhibitor Market Dynamics</h3>
        </div>
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="pl-6 border-l-2 border-primary italic text-lg leading-relaxed text-teal-soft">
        ...
        <div className="lg:col-span-4 bg-navy-deep text-white p-8 rounded-sm">
          ...
          <ul className="space-y-6">
            <li className="flex gap-4">
              <span className="text-primary font-serif italic text-2xl leading-none">01</span>
            ...
            <li className="flex gap-4">
              <span className="text-primary font-serif italic text-2xl leading-none">02</span>
