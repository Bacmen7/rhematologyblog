  ...
  return (
    ...
    >
      ...
      <div className="hidden md:block" style={{ width: "200px", flexShrink: 0, overflow: "hidden" }}>
        <img src="/rheumatologist-doctor-bangalore/images/12hero-slide-1.webp" alt="" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center top", display: "block" }} />
      </div>
    </div>
  )
}
