          ...
          <div>
            ...
            {submitted ? (
              <div style={{ textAlign: "center", padding: "2rem 0" }}>
                <div style={{ width: "52px", height: "52px", borderRadius: "50%", backgroundColor: "rgba(255,255,255,0.15)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
                  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                    <polyline points="20 6 9 17 4 12" />
                  </svg>
                </div>
                <p style={{ fontFamily: "var(--font-display)", fontSize: "1.1rem", fontWeight: 700, color: "#fff", margin: "0 0 8px" }}>Successfully Booked!</p>
                <p style={{ fontFamily: "'usual', system-ui, sans-serif", fontSize: "13px", color: "rgba(255,255,255,0.7)", margin: 0 }}>We'll call you back within 24 hours.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                ...
                <a href="https://wa.me/918290638358" style={{
                  marginTop: "12px",
                  width: "100%", padding: "12px",
                  backgroundColor: "#25D366", color: "#fff",
                  borderRadius: "100px", fontWeight: 600, fontSize: "13px",
                  fontFamily: "'usual', system-ui, sans-serif",
                  textDecoration: "none",
