const specialists = [
  {
    ...
    education: [
      "MBBS (2012) – Father Muller Medical College, Mangalore",
      "MD in Internal Medicine (2016) – Rajasthan University of Health Sciences",
      "DM in Rheumatology & Clinical Immunology (2020) – Tamil Nadu Dr M.G.R. Medical University",
    ],
    expertise: [
      ...
      "Psoriatic Arthritis",
      "Vasculitis",
      "SLE and Other Systemic Autoimmune Illness",
      "Intra-Articular Injections",
    ],
    awards: [
      "Gold Medalist in DM Rheumatology and Clinical Immunology in TN MGR University",
    ],
    publications: [
      "Efficacy of Tocilizumab in patients with Takayasu's arteritis single-centre prospective study",
      "A study of HLA phenotype prevalence in patients with Spondyloarthritis at a Tertiary care centre",
      "Estimation of Interleukin 1β levels in acute gout patients before and after colchicine",
      "A study of Clinico-radiological and Sociodemographic profile of patients with Stroke in a tertiary care hospital of South West Rajasthan",
