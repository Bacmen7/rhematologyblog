  ...
  return (
    <div className="antialiased overflow-x-hidden relative" style={{ fontFamily: "var(--font-base)" }}>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        .pos-4 { top: 50%; right: -12%; width: 90px; height: 90px; transform: translate(0, -50%) rotate(45deg); border-color: #fa885a; border-width: 3px; }
  ...
  return (
    <>
      ...
      <section className="custom-approach-section relative overflow-hidden hidden lg:block" style={{ background: "#e0f3f5" }}>
        <div className="grid grid-cols-2 items-stretch min-h-[76vh]">
          <div className="flex flex-col justify-center gap-6 py-16 pl-[max(8rem,calc((100%-80rem)/2+8rem))] pr-10">
            <p className="text-[11px] font-bold tracking-[0.2em] text-[#1A355D] uppercase">Our Approach</p>
      ...
      <section className="custom-approach-section lg:hidden overflow-hidden">
        <div className="flex flex-col items-center text-center px-6 pt-14 pb-10" style={{ background: "#e0f3f5" }}>
          <p className="text-[11px] font-bold tracking-[0.2em] text-[#1A355D] uppercase mb-5">Our Approach</p>
          ...
          <button className="bg-primary hover:bg-primary-hover text-white px-8 py-3.5 rounded-full font-bold text-base transition-colors mb-5">
            Get Started →
          </button>
        </div>
        <img
    ...
    <section className="py-24 md:py-32 bg-[#FDFDFE] relative z-10 overflow-hidden">
      <div className="max-w-[1100px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="space-y-10 pr-4">
          <div>
            <h2 className="text-4xl md:text-[2.75rem] mb-4 text-[#1A355D] leading-tight" style={{ fontFamily: "var(--font-display)" }}>How Rheuma works</h2>
              ...
              return (
                <div key={step.id} onClick={() => setActiveStep(step.id)} className={`flex gap-5 group cursor-pointer transition-opacity duration-300 ${!isActive ? 'opacity-70 hover:opacity-100' : ''}`}>
                  <div className="relative flex-shrink-0 w-8 h-8 flex items-center justify-center font-bold text-sm z-10 mt-1">
                    <span className={`relative z-10 transition-colors ${isActive ? 'text-[#1A355D]' : 'text-[#A0A4AC]'}`}>{step.id}</span>
                    <svg className={`absolute blob-bg w-[160%] h-[160%] transition-colors duration-300 ${isActive ? 'text-[#fa885a]' : 'text-[#F4F7FC]'}`} viewBox="0 0 70 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div>
                    <h4 className={`text-[17px] font-bold mb-2 transition-colors ${isActive ? 'text-[#1A355D]' : 'text-[#A0A4AC]'}`}>{step.title}</h4>
                    {isActive && (
          ...
          <div className="relative z-10">
            ...
            <div className="relative w-[260px] h-[530px] bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.08)] overflow-hidden">
              ...
              <div className="absolute bottom-6 left-0 w-full flex justify-center items-center gap-2.5 z-20 px-2">
                <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-[#1A355D] shadow-md cursor-pointer hover:bg-gray-50">
                ...
                <div className="w-10 h-10 rounded-full bg-[#fa885a] text-[#462E26] flex items-center justify-center shadow-md cursor-pointer hover:bg-orange-300">
  ...
  return (
    <div className="w-full leading-none -mb-1 relative z-20">
      <svg viewBox="0 0 1440 32" className="w-full h-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1440 29.3627C1194.13 4.45308 925.369 -5.17758 665.739 2.66577C461.219 8.84327 260.254 25.3195 53.9922 21.8056C35.9416 21.5019 17.9345 21.0248 0 20.4001V32H1440V29.3627Z" fill="#F5F5F5"></path>
      </svg>
    </div>
  )
}
    ...
    <section className="py-20 bg-[#F5F5F5]">
      <div className="max-w-[1000px] mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-[3rem] inline-block relative text-[#1A355D] tracking-tight" style={{ fontFamily: "var(--font-display)" }}>
              ...
              {rows.map((text, index) => {
                ...
                return (
                  <tr key={index} className={`${bgWhite ? 'bg-white' : ''} rounded-full`}>
                    <td className={`py-[18px] pl-10 text-[14.5px] font-light text-[#1A355D] rounded-l-full ${bgWhite ? 'border border-transparent' : ''}`}>
                      {text}
                    </td>
                    <td className={`py-[18px] text-center ${bgWhite ? 'border-y border-transparent' : ''}`}>
                      <div className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-[#1AA3B5] text-teal-800">
  ...
  return (
    <section className="py-24 bg-[#FDFDFE] relative z-10">
      <div className="max-w-[1200px] mx-auto px-6 text-center">
        <h2 className="text-3xl md:text-[2.75rem] mb-20 text-[#1A355D]" style={{ fontFamily: "var(--font-display)" }}>The numbers behind our care</h2>
              ...
              <div className="relative flex justify-center items-center mb-6">
                <div className="absolute z-0 flex items-center justify-center">
                  <svg width="85" height="90" viewBox={stat.vb} fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d={stat.blob} fill="#e0f3f5"></path>
                  </svg>
                </div>
                <span className="text-7xl md:text-[5.5rem] text-[#1A355D] font-normal tracking-tight relative z-10 leading-none" style={{ fontFamily: "var(--font-display)" }}>{stat.value}</span>
              </div>
...
function DarkBanner() {
  return (
    <section className="bg-[#0f616e] text-white relative py-16">
      {/* Top Wave */}
      <div className="absolute top-0 left-0 w-full leading-none -translate-y-[98%]">
        <svg viewBox="0 0 1440 16" className="w-full h-auto block" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M428.1 14.2289C654.82 14.2289 823.319 0 1053.1 0C1196.21 0 1315.56 5.51969 1440 9.68339V16H0V3.1744C141.3 7.36788 270.666 14.2289 428.1 14.2289Z" fill="#0f616e"></path>
        </svg>
      </div>
  ...
  return (
    <section className="bg-[#FDFDFE] pt-24 pb-20 relative z-10">
      <div className="max-w-[1100px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        {/* Quote Box */}
        <div className="relative z-10 lg:-ml-12 text-[#1A355D]">
          <span className="absolute -top-12 -left-6 text-7xl text-[#F5F5F5] leading-none" style={{ fontFamily: "var(--font-display)" }}>"</span>
          ...
          <div className="flex gap-3 mt-8">
            <button className="w-8 h-8 rounded-full bg-[#1AA3B5] text-teal-800 flex items-center justify-center hover:bg-teal-300 transition-colors">
            ...
            <div key={v.quote} className="group cursor-pointer">
              <div className="relative overflow-hidden rounded-[4px] aspect-video mb-4 shadow-[0_4px_12px_rgba(0,0,0,0.1)]">
                ...
                <div className="absolute bottom-4 left-4">
                  <div className="w-10 h-10 bg-[#1AA3B5] rounded-full flex items-center justify-center shadow-md border-2 border-[#1AA3B5] group-hover:scale-110 transition-transform">
                    <svg className="w-4 h-4 ml-1 text-teal-900" fill="currentColor" viewBox="0 0 20 20"><path d="M4 4l12 6-12 6z"></path></svg>
                  </div>
                </div>
              </div>
              <h3 className="text-[15px] text-[#1A355D] tracking-wide" style={{ fontFamily: "var(--font-display)" }}>{v.quote}</h3>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="flex flex-col gap-12 max-w-[850px] mx-auto">
          ...
          <a href="#" className="flex flex-col md:flex-row gap-10 items-center group">
            ...
            <div className="w-full">
              ...
              <h3 className="text-xl font-bold mb-5 text-[#1A355D] leading-snug group-hover:text-[#1AA3B5] transition-colors">Our outcomes data: what 2,400 patients taught us</h3>
              <span className="inline-flex items-center text-[13px] font-bold text-[#1A355D]">
                Read more
                <div className="ml-3 w-[26px] h-[26px] rounded-full bg-[#1AA3B5] flex items-center justify-center text-teal-900 group-hover:bg-teal-300 transition-colors">
          ...
          <a href="#" className="flex flex-col md:flex-row gap-10 items-center group">
            ...
            <div className="w-full">
              <span className="inline-block bg-[#e0f3f5] text-[#1A355D] text-[10px] font-bold tracking-[0.15em] uppercase px-4 py-1.5 rounded-full mb-4">June 26, 2025</span>
              <h3 className="text-xl font-bold mb-5 text-[#1A355D] leading-snug group-hover:text-[#1AA3B5] transition-colors">Published in the American College of Rheumatology journal</h3>
              <span className="inline-flex items-center text-[13px] font-bold text-[#1A355D]">
                Read more
                <div className="ml-3 w-[26px] h-[26px] rounded-full bg-[#1AA3B5] flex items-center justify-center text-teal-900 group-hover:bg-teal-300 transition-colors">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 12h14M12 5l7 7-7 7"></path></svg>
