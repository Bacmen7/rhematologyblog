  ...
  return (
    <div className="landing-page bg-white text-navy-deep antialiased">
      ...
      <main>
        ...
        <section className="custom-approach-section relative overflow-hidden" style={{ backgroundColor: "#a0e2e4" }}>
                ...
                <div className="flex-1 flex justify-end">
                  <div className="bg-white shadow-[0_8px_40px_rgba(15,97,110,0.12)] overflow-hidden" style={{ borderRadius: 0, maxWidth: "380px", width: "100%" }}>
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-[14px] font-semibold text-navy-deep mb-1">Senior Consultant Rheumatologist</p>
                      <p className="text-[13px] text-navy-muted mb-5">MD &middot; DM Rheumatology (AIIMS)</p>
                      <Link
                        to="/specialist/1"
          ...
          <div className="lg:hidden">
            <div className="flex flex-col items-center text-center px-6 pt-14 pb-10">
              ...
              <p className="text-base leading-relaxed mb-8 max-w-sm" style={{ color: "#1A355D", opacity: 0.75 }}>
                Rheuma&apos;s rheumatologists identify your specific condition and build a care plan that works.
              </p>
              <a
                href="#"
                className="inline-block rounded-full font-semibold text-[15px] transition-all hover:opacity-90 mb-10"
                style={{ backgroundColor: "#0f616e", color: "#ffffff", padding: "14px 32px" }}
              >
                Book an Appointment
              </a>
              ...
              <div className="bg-white shadow-[0_8px_30px_rgba(15,97,110,0.1)] overflow-hidden w-full max-w-[340px]" style={{ borderRadius: 0 }}>
                ...
                <div className="p-5 text-left">
                  ...
                  <h3 className="text-navy-deep text-[1.25rem] mb-1" style={{ fontFamily: "var(--font-display)", fontWeight: 400, lineHeight: 1.2 }}>
                    Dr. Priya Menon
                  </h3>
                  <p className="text-[13px] font-semibold text-navy-deep mb-0.5">Senior Consultant Rheumatologist</p>
        ...
        <section style={{ backgroundColor: "#0f2b3c" }}>
          {/* Top content area */}
          <div className="max-w-7xl mx-auto px-6 pt-16 md:pt-24 pb-10 md:pb-14">
            <h2
              style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 4vw, 2.75rem)", fontWeight: 400, lineHeight: 1.1, letterSpacing: "-0.5px", color: "#ffffff", marginBottom: "1.25rem" }}
            >
              Arthritis — The Scale of the Problem
            </h2>
            <div className="w-16 h-[2px] mb-6" style={{ backgroundColor: "#1AA3B5" }} />
            <p className="text-[16px] leading-[1.85] max-w-2xl" style={{ color: "rgba(255,255,255,0.6)" }}>
          ...
          <div className="max-w-7xl mx-auto px-6 pb-16 md:pb-24">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              {/* Card 1 — 1% */}
              <div className="p-6 md:p-7" style={{ backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 0 }}>
                <p
                  className="mb-1"
                  style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2.5rem, 4vw, 3.25rem)", fontWeight: 400, lineHeight: 1, color: "#1AA3B5" }}
                >
                  1%
                </p>
                <p className="text-[14px] font-semibold mb-3" style={{ color: "#ffffff" }}>of the global population</p>
                <p className="text-[13px] leading-[1.7]" style={{ color: "rgba(255,255,255,0.5)" }}>
                  has Rheumatoid Arthritis alone. Over 100 types of arthritis exist; combined, they are the leading cause of disability worldwide.
                </p>
              </div>
              ...
              <div className="p-6 md:p-7" style={{ backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 0 }}>
                ...
                <p className="text-[14px] font-semibold mb-3" style={{ color: "#ffffff" }}>patients in India</p>
                <p className="text-[13px] leading-[1.7]" style={{ color: "rgba(255,255,255,0.5)" }}>
                  Estimated adults affected — exceeding the combined burden of diabetes and all cancers. Average diagnosis delay: 6 years.
                </p>
              </div>
              ...
              <div className="p-6 md:p-7" style={{ backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 0 }}>
                ...
                <p className="text-[14px] font-semibold mb-3" style={{ color: "#ffffff" }}>work disability in 10 yrs</p>
                <p className="text-[13px] leading-[1.7]" style={{ color: "rgba(255,255,255,0.5)" }}>
                  Of RA patients experience significant work disability within 10 years without early, targeted therapy. Early treatment changes this outcome dramatically.
                </p>
              </div>

              {/* Card 4 — 3× gender stat with bar chart */}
              <div className="p-6 md:p-7" style={{ backgroundColor: "rgba(255,255,255,0.05)", borderRadius: 0 }}>
                {/* Mini bar chart */}
                <div className="flex items-end gap-3 mb-4">
                  <div className="flex flex-col items-center gap-1">
                    <div className="w-7 rounded-sm" style={{ height: "40px", backgroundColor: "#1AA3B5" }} />
                    <span className="text-[10px]" style={{ color: "rgba(255,255,255,0.4)" }}>3&times;</span>
                  </div>
                  <div className="flex flex-col items-center gap-1">
                    <div className="w-7 rounded-sm" style={{ height: "16px", backgroundColor: "#1AA3B5", opacity: 0.4 }} />
                    <span className="text-[10px]" style={{ color: "rgba(255,255,255,0.4)" }}>1&times;</span>
                  </div>
                </div>
                <p className="text-[14px] font-semibold mb-3" style={{ color: "#ffffff" }}>
                  RA is 3&times; more common in women
                </p>
                <p className="text-[13px] leading-[1.7]" style={{ color: "rgba(255,255,255,0.5)" }}>
                  Conversely, AS (Ankylosing Spondylitis) is 2–3&times; more prevalent in men, typically under 35 years old.
                </p>
              </div>
        ...
        <section id="types" className="py-20 md:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="mb-14 max-w-2xl">
              ...
              <div className="w-14 h-[2px] mb-5" style={{ backgroundColor: "#1AA3B5" }} />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-6">
              {[
                { emoji: "\uD83D\uDC4B", label: "Rheumatoid Arthritis", abbr: "RA", link: "/health-guide/Rheumatoid-Arthritis" },
                { emoji: "\uD83E\uDDB4", label: "Osteoarthritis", abbr: "OA", link: "/health-guide" },
                { emoji: "\uD83E\uDDEC", label: "Psoriatic Arthritis", abbr: "PSA", link: "/health-guide" },
                { emoji: "\uD83C\uDFC3", label: "Ankylosing Spondylitis", abbr: "AS", link: "/health-guide" },
              ].map((type, i) => (
                <Link
                  key={i}
                  to={type.link}
                ...
                >
                  {/* Circle */}
                  <div
                    className="w-[130px] h-[130px] md:w-[150px] md:h-[150px] rounded-full border-2 flex items-center justify-center mb-5 transition-all duration-300 group-hover:shadow-[0_4px_20px_rgba(26,163,181,0.15)] group-hover:border-primary"
                    style={{ borderColor: "#e2e8f0" }}
                  >
                    <span className="text-[40px] md:text-[48px]">{type.emoji}</span>
                  </div>
                  <h3
                  ...
                  <span
                    className="inline-block text-[11px] font-bold uppercase tracking-[0.12em] px-3 py-1 rounded-full"
                    style={{ backgroundColor: "#e0f3f5", color: "#1AA3B5" }}
                  >
                    {type.abbr}
                  </span>
                </Link>
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <button
                  key={i}
                  className="group flex items-center gap-3.5 bg-white p-4 md:p-5 border border-gray-100 hover:shadow-[0_4px_16px_rgba(24,36,57,0.07)] hover:-translate-y-0.5 transition-all duration-200 text-left"
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="lg:flex lg:gap-12 xl:gap-16 items-start">
              ...
              <div className="flex-1 mb-12 lg:mb-0 lg:sticky lg:top-[140px] self-start">
                <div className="bg-ghost p-6 md:p-8 border border-gray-100" style={{ borderRadius: 0 }}>
                  <h3
                  ...
                  <div key={step.num} className="flex gap-5">
                    <div className="shrink-0">
                      <div
                        ...
                        style={{ backgroundColor: "#e0f3f5", color: "#0f616e", border: "2px solid #1AA3B5" }}
                      >
                        {step.num}
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="text-[14.5px] leading-[1.8] text-navy-muted">{step.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
              {[
                ...
                <div
                  ...
                  style={{ backgroundColor: "#faf7f2", borderRadius: 0, padding: "2.25rem 1.75rem 2rem", boxShadow: "0 2px 12px rgba(24,36,57,0.04)" }}
                >
        ...
        <section className="py-20 md:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-14 max-w-2xl">
              <span className="text-[11px] font-bold tracking-[0.1em] uppercase" style={{ color: "#1AA3B5" }}>06 — Management Pathways</span>
              <h2 className="text-navy-deep mt-1 mb-3" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 4vw, 2.75rem)", fontWeight: 400, lineHeight: 1.1, letterSpacing: "-0.5px" }}>
                Treatment Options
              </h2>
              <div className="w-9 h-[3px] mb-5" style={{ backgroundColor: "#1AA3B5", borderRadius: "2px" }} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Card 1: Medicines */}
              <div className="border overflow-hidden flex flex-col" style={{ borderRadius: "20px", borderColor: "#dde6ee" }}>
        ...
        <section className="py-20 md:py-28 bg-ghost">
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-14 max-w-2xl">
              <span className="text-[11px] font-bold tracking-[0.1em] uppercase" style={{ color: "#1AA3B5" }}>07 — Self-Management</span>
              <h2 className="text-navy-deep mt-1 mb-3" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 4vw, 2.75rem)", fontWeight: 400, lineHeight: 1.1, letterSpacing: "-0.5px" }}>
            ...
            {/* Photo + text row */}
            <div className="lg:grid lg:grid-cols-[400px_1fr] overflow-hidden mb-8" style={{ borderRadius: "20px", border: "1.5px solid #dde6ee" }}>
              {/* Photo side */}
              <div className="relative h-[260px] lg:h-auto overflow-hidden">
                ...
                <div className="absolute bottom-4 left-5 right-5">
                  <p className="text-[13px] leading-[1.6]" style={{ color: "rgba(255,255,255,.75)" }}>
                    <strong className="text-white">Movement is medicine.</strong> Regular, low-impact exercise — swimming, cycling, walking — reduces inflammatory markers and is as important as medication in long-term arthritis management.
                  </p>
                </div>
              </div>
              {/* Text side */}
        ...
        <section className="py-20 md:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-14 max-w-2xl">
              <span className="text-[11px] font-bold tracking-[0.1em] uppercase" style={{ color: "#1AA3B5" }}>08 — How We Support You</span>
              <h2 className="text-navy-deep mt-1 mb-3" style={{ fontFamily: "var(--font-display)", fontSize: "clamp(2rem, 4vw, 2.75rem)", fontWeight: 400, lineHeight: 1.1, letterSpacing: "-0.5px" }}>
                The Role of <em style={{ fontStyle: "italic", color: "#1AA3B5" }}>RheumaCare</em>
              </h2>
              <div className="w-9 h-[3px] mb-5" style={{ backgroundColor: "#1AA3B5", borderRadius: "2px" }} />
              <p className="text-[15px] leading-[1.8] text-navy-muted">
              ...
              {[
                {
                  ...
                  desc: "An autoimmune disease where the immune system attacks the synovium — the lining of the joints. It typically affects small joints symmetrically and can cause systemic complications.",
                  icon: "psychology_alt",
                  link: "/health-guide/Rheumatoid-Arthritis",
                },
                {
                  title: "Psoriatic Arthritis (PsA)",
                  desc: "An inflammatory arthritis associated with psoriasis. It can affect any joint, often causing swollen fingers and toes (dactylitis), and may also involve the spine and entheses.",
                  icon: "dermatology",
                  link: "/health-guide",
                },
                {
                  title: "Osteoarthritis (OA)",
                  desc: "A degenerative joint disease caused by the breakdown of cartilage. It commonly affects weight-bearing joints like the knees, hips, and spine, worsening with age and overuse.",
                  icon: "skeleton",
                  link: "/health-guide",
                },
                {
                  title: "Ankylosing Spondylitis",
                  desc: "A chronic inflammatory condition primarily affecting the spine and sacroiliac joints. Over time, it can cause vertebrae to fuse together, leading to reduced flexibility.",
                  icon: "accessibility_new",
                  link: "/health-guide",
                },
                {
                  title: "Gout",
                  desc: "An inflammatory arthritis triggered by the buildup of uric acid crystals in joints. It causes sudden, severe attacks of pain, swelling, and redness — most often in the big toe.",
                  icon: "water_drop",
                  link: "/health-guide",
                },
                {
                  title: "Lupus Arthritis",
                  desc: "Joint pain and swelling caused by systemic lupus erythematosus (SLE). Unlike RA, lupus arthritis is typically non-erosive but can be equally disabling during flares.",
                  icon: "immunology",
                  link: "/health-guide",
                },
              ].map((condition, i) => (
                <Link
                  key={i}
                  to={condition.link}
                  className="group bg-white border border-gray-100 p-7 hover:shadow-[0_8px_30px_rgba(24,36,57,0.08)] transition-all duration-300 hover:-translate-y-1"
                  style={{ borderRadius: 0 }}
                >
                  <div
                    className="w-12 h-12 rounded-full flex items-center justify-center mb-5 transition-colors duration-300"
                    style={{ backgroundColor: i % 2 === 0 ? "#e0f3f5" : "#fdd3bc" }}
                  >
                    <span className="material-symbols-outlined text-[22px] text-navy-deep">{condition.icon}</span>
                  </div>
                  <h3
                    className="text-navy-deep mb-3 group-hover:text-primary transition-colors"
                    style={{ fontFamily: "var(--font-display)", fontSize: "1.25rem", fontWeight: 400, lineHeight: 1.25 }}
                  >
                    {condition.title}
                  </h3>
                  <p className="text-[14px] leading-[1.7] text-navy-muted mb-5">{condition.desc}</p>
                  <span className="inline-flex items-center text-[13px] font-semibold text-navy-deep group-hover:text-primary transition-colors">
                    Learn more
                    <span className="ml-2 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
        ...
        <section className="relative">
          {/* Wave top */}
          <svg viewBox="0 0 1440 32" className="w-full h-auto block -mb-1" fill="none">
          ...
          <div className="bg-navy-deep py-20 md:py-28">
            <div className="max-w-7xl mx-auto px-6">
                    ...
                    {warningSignsEarly.map((sign, i) => (
                      ...
                      >
                        <div className="w-7 h-7 rounded-full flex items-center justify-center shrink-0 mt-0.5" style={{ backgroundColor: "#1AA3B5" }}>
                          <svg className="w-3.5 h-3.5" fill="none" stroke="#0f616e" strokeWidth={2.5} viewBox="0 0 24 24">
        ...
        <section className="py-20 md:py-28 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-[16px] text-navy-muted leading-relaxed mt-5 max-w-lg mx-auto">
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex items-end justify-between mb-10">
              <div>
                ...
                <div className="w-9 h-[3px]" style={{ backgroundColor: "#1AA3B5", borderRadius: "2px" }} />
              </div>
            ...
            <div className="lg:grid lg:grid-cols-[1.6fr_1fr] gap-6 items-start">

              {/* Featured article — left */}
              <Link
                to="/blog"
                className="group block overflow-hidden border hover:shadow-[0_10px_30px_rgba(15,36,64,.1)] hover:-translate-y-0.5 transition-all duration-300"
                style={{ borderRadius: "16px", borderColor: "#dde6ee" }}
              >
                <div className="h-[280px] overflow-hidden relative">
                  ...
                  />
                  <div className="absolute bottom-0 left-0 right-0 h-[55%]" style={{ background: "linear-gradient(to top, rgba(15,36,64,.52), transparent)" }} />
                </div>
                <div className="p-6 md:p-7">
                  <div className="flex items-center gap-2 mb-3">
                    <span className="w-4 h-[2px]" style={{ backgroundColor: "#1AA3B5" }} />
                    <span className="text-[10px] font-bold uppercase tracking-[0.08em]" style={{ color: "#1AA3B5" }}>Featured &middot; Rheumatoid Arthritis</span>
                  </div>
                  <h3
                    className="text-navy-deep mb-3 group-hover:text-primary transition-colors"
                    style={{ fontFamily: "var(--font-display)", fontSize: "1.3rem", fontWeight: 400, lineHeight: 1.25 }}
                  >
                    Why the First 3 Months After Diagnosis Are the Most Important of Your Life
                  </h3>
                  <p className="text-[14px] text-navy-muted leading-[1.65] mb-5">
                  ...
                  <div className="flex flex-wrap items-center gap-5 pt-4" style={{ borderTop: "1px solid #edf0f5" }}>
                    <span className="inline-flex items-center gap-1.5 text-[12px] text-navy-muted">
                      <span className="material-symbols-outlined text-[15px]" style={{ color: "#e05a5a" }}>person</span>
                      Dr. P. Menon MD DM
                    </span>
                    <span className="inline-flex items-center gap-1.5 text-[12px] text-navy-muted">
                      <span className="material-symbols-outlined text-[15px]" style={{ color: "#1AA3B5" }}>schedule</span>
                      10 min
                    </span>
                    <span className="inline-flex items-center gap-1.5 text-[12px] text-navy-muted">
                      <span className="material-symbols-outlined text-[15px]" style={{ color: "#1AA3B5" }}>calendar_month</span>
                      Feb 2026
                    </span>
                  </div>
                </div>
              ...
              <div className="flex flex-col gap-4 mt-6 lg:mt-0">
                {[
                  {
                    img: "https://images.unsplash.com/photo-1585435557343-3b092031a831?auto=format&fit=crop&w=200&q=80",
                    cat: "Medications",
                    catColor: "#e05a5a",
                    catBg: "#fde8e8",
                  ...
                  {
                    img: "https://images.unsplash.com/photo-1559757175-7cb057fba93c?auto=format&fit=crop&w=200&q=80",
                    cat: "Patient Guide",
                    catColor: "#1AA3B5",
                    catBg: "#e0f3f5",
                  ...
                  <Link
                    key={i}
                    to="/blog"
                    className="group flex items-center gap-4 p-4 border hover:border-primary hover:shadow-[0_4px_16px_rgba(15,36,64,.07)] transition-all duration-200"
                    style={{ borderRadius: "13px", borderColor: "#dde6ee" }}
                  >
                    <div className="w-[68px] h-[68px] rounded-[9px] overflow-hidden shrink-0">
                      <img src={article.img} alt={article.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-400" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <span
                        className="text-[9px] font-bold uppercase tracking-[0.06em] mb-1.5 inline-block px-2 py-0.5 rounded-full"
                        style={{ color: article.catColor, backgroundColor: article.catBg }}
                      >
                        {article.cat}
                      </span>
                      <h4
                        className="text-navy-deep group-hover:text-primary transition-colors mb-1 line-clamp-2"
                        style={{ fontFamily: "var(--font-display)", fontSize: "0.92rem", fontWeight: 400, lineHeight: 1.3 }}
                      >
                        {article.title}
                      </h4>
                      <span className="text-[11px] text-navy-muted flex items-center gap-1.5">
                        <span className="material-symbols-outlined text-[12px]">schedule</span>
                        {article.meta}
                      </span>
                    </div>
                    <div
                      className="w-9 h-9 rounded-full flex items-center justify-center shrink-0 group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all duration-200"
                      style={{ backgroundColor: "#eef6fc", border: "1.5px solid #dde6ee" }}
                    >
            ...
            <div className="mt-8 text-center md:hidden">
              <Link to="/blog" className="text-[14px] font-semibold" style={{ color: "#1AA3B5" }}>
                View all articles &rarr;
              </Link>
            </div>
          </div>
