            ...
            <div className="lg:flex lg:gap-14">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mb-10">
                  <img src="/rheumatologist-doctor-bangalore/raghav.webp" alt="Dr. Raghavendra H" className="w-10 h-10 rounded-full object-cover object-top bg-[#f0cfc4]" />
                  <div>
                  ...
                  <div className="border border-border overflow-hidden" style={{ borderRadius: 0, marginBottom: "2.5rem" }}>
                    <div className="flex">
                      <div className="hidden md:block w-[220px] shrink-0">
                        <img src="/rheumatologist-doctor-bangalore/images/hero-doctor.webp" alt="Rheuma specialist" className="w-full h-full object-cover" />
                      </div>
                      <div className="flex-1 p-5 md:p-6">
                        ...
                        <div className="flex items-start gap-3 mb-4">
                          <img src="/rheumatologist-doctor-bangalore/raghav.webp" alt="" className="w-10 h-10 rounded-full object-cover object-top bg-[#f0cfc4] shrink-0" />
                        ...
                        <div className="flex items-start gap-3 mb-4">
                          <img src="/rheumatologist-doctor-bangalore/d1.webp" alt="" className="w-10 h-10 rounded-full object-cover object-top bg-[#dce7f7] shrink-0" />
                        ...
                        <div className="flex items-start gap-3">
                          <img src="/rheumatologist-doctor-bangalore/d2.webp" alt="" className="w-10 h-10 rounded-full object-cover object-top bg-[#e0f3f5] shrink-0" />
