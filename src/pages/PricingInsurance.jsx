      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 relative">
          ...
          <div className="text-center px-6 md:px-12 py-12 md:py-16">
            <div className="w-16 h-16 rounded-full bg-[#E3EFFF] flex items-center justify-center mx-auto mb-6">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#182439" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                <path d="M16 3h5v5" />
                <path d="M8 3H3v5" />
              ...
              <svg className="-ml-3 -mt-6" width="14" height="14" viewBox="0 0 20 20" fill="#5ba8a3">
                <circle cx="10" cy="10" r="10" fill="#5ba8a3" />
                <path d="M6 10l3 3 5-5" stroke="white" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <h3 className="text-[1.75rem] md:text-[2rem] tracking-tight mb-5 text-[#182439]" style={{ fontFamily: "var(--font-display)" }}>
              In-network pricing
            </h3>
            <p className="text-navy-muted text-[15px] leading-[1.75] max-w-md mx-auto">
              ...
              <a href="#" className="font-semibold text-[#182439] underline decoration-[#182439] decoration-[1.5px] underline-offset-[3px] hover:decoration-[#5ba8a3] transition-colors">
          ...
          <div className="text-center px-6 md:px-12 py-12 md:py-16 border-t md:border-t-0 md:border-l border-[#dadfe8]/60">
            <div className="w-16 h-16 rounded-full bg-[#E3EFFF] flex items-center justify-center mx-auto mb-6">
              ...
              <svg className="-ml-3 -mt-6" width="14" height="14" viewBox="0 0 20 20">
                <circle cx="10" cy="10" r="10" fill="#ffb59d" />
...
function InsuranceSupportSection() {
  return (
    <section className="bg-[#F0F4FB] relative z-10">
      {/* Top Wave */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 flex flex-col gap-10">
              ...
              <div>
                <Link
                  to="/"
                  className="inline-block bg-[#b1efec] hover:bg-[#92d9d5] text-[#182439] px-8 py-3 rounded-full font-semibold text-[15px] transition-colors"
                >
    ...
    <section id="plans" className="py-24 md:py-32 bg-[#FDFDFE] relative z-10">
      <div className="max-w-[1200px] mx-auto px-6">
        <div className="text-center mb-16">
          <p className="text-[11px] font-bold tracking-[0.2em] text-[#5ba8a3] uppercase mb-5">Care Plans</p>
          <h2 className="text-4xl md:text-[3rem] text-[#182439] tracking-tight" style={{ fontFamily: "var(--font-display)" }}>
            Simple plans,{" "}
            <span className="relative inline-block">
              real pricing
          ...
          <p className="text-[#3b5b80] text-[15px] leading-relaxed mt-4 font-light max-w-md mx-auto">
            ...
            return (
              <div
                ...
                className={`relative flex flex-col rounded-[4px] overflow-hidden transition-all duration-300 hover:-translate-y-1 ${
                  isPopular
                    ? "bg-[#182439] text-white shadow-[0_20px_50px_rgba(24,36,57,0.2)]"
                    : "bg-white border border-[#dadfe8]/60"
                }`}
              >
                {isPopular && (
                  <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#b1efec] via-[#8ebfff] to-[#feccbc]" />
                )}
                <div className="p-8 md:p-10 flex flex-col flex-1">
                  {plan.badge && (
                    <span className="inline-flex self-start items-center px-3 py-1 rounded-full bg-[#b1efec]/20 text-[#b1efec] text-[10px] font-bold uppercase tracking-[0.15em] mb-5">
                      {plan.badge}
                    </span>
                  )}
                  <h3
                  ...
                  <p className={`text-[14px] leading-relaxed mb-8 font-light ${isPopular ? "text-white/60" : "text-[#3b5b80]"}`}>
                    {plan.desc}
                  </p>
                  <ul className="space-y-3.5 mb-10 flex-1">
                    {plan.features.map((f) => (
                      <li key={f} className="flex items-start gap-3 text-[14px]">
                        <div className={`mt-0.5 w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0 ${isPopular ? "bg-[#b1efec]/15" : "bg-[#b1efec]/30"}`}>
                          <svg className={`w-3 h-3 ${isPopular ? "text-[#b1efec]" : "text-[#5ba8a3]"}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" />
                          </svg>
                        </div>
                        <span className={isPopular ? "text-white/80" : "text-[#182439]"}>{f}</span>
                      </li>
                    ))}
                  </ul>
                  <Link
                    ...
                    className={`block text-center px-6 py-3.5 rounded-full font-semibold text-[14px] transition-all duration-200 ${
                      isPopular
                        ? "bg-[#b1efec] text-[#182439] hover:bg-[#92d9d5]"
                        : "bg-[#182439] text-white hover:bg-[#182439]/90"
                    }`}
                  >
                    Get Started
                  </Link>
...
function WhatsIncluded() {
  return (
    <section className="custom-approach-section relative overflow-hidden bg-[#182439] text-white">
      {/* Top Wave */}
      <div className="absolute top-0 left-0 w-full leading-none -translate-y-[98%]">
        <svg viewBox="0 0 1440 16" className="w-full h-auto block" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M428.1 14.2289C654.82 14.2289 823.319 0 1053.1 0C1196.21 0 1315.56 5.51969 1440 9.68339V16H0V3.1744C141.3 7.36788 270.666 14.2289 428.1 14.2289Z" fill="#182439" />
        </svg>
      </div>
            ...
            {[
              ...
              <div key={item.title} className="flex items-start gap-6 group">
                <div className="relative flex h-14 w-14 shrink-0 items-center justify-center mt-1">
                  ...
                  <span className="material-symbols-outlined relative z-10 text-[26px] text-[#b1efec]">{item.icon}</span>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <span className="relative inline-block">
                ...
                <svg className="absolute -bottom-1 left-0 w-full h-[6px]" fill="none" preserveAspectRatio="none" viewBox="0 0 400 12">
                  <path d="M2 10C80 4 200 2 398 6" stroke="#c7dfff" strokeLinecap="round" strokeWidth="4" />
                </svg>
              </span>
          ...
          <div className="grid grid-cols-3 gap-3">
            {insurers.map((ins) => (
              <div
                key={ins.name}
                className="bg-[#F0F4FB] rounded-[4px] h-[100px] flex items-center justify-center px-4"
              >
                <span className="text-[15px] font-bold text-[#3b5b80]/60 tracking-tight text-center leading-tight">{ins.name}</span>
              </div>
            ))}
          </div>
        </div>
                ...
                {[
                  ...
                  return (
                    <tr key={cat} className={even ? "bg-white" : ""}>
                      <td className={`py-[18px] pl-8 text-[14.5px] font-medium text-[#182439] ${even ? "rounded-l-full" : ""}`}>{cat}</td>
                      <td className="py-[18px] text-center text-[14px] font-light text-[#a0a4ac]">{trad}</td>
                      <td className={`py-[18px] text-center text-[14px] font-semibold text-[#182439] ${even ? "rounded-r-full" : ""}`}>
                        <span className="inline-flex items-center gap-2">
                          <span className="w-5 h-5 rounded-full bg-[#b1efec] inline-flex items-center justify-center flex-shrink-0">
          ...
          <div className="lg:col-span-7 lg:col-start-6 grid sm:grid-cols-2 gap-x-12 gap-y-14">
            {options.map((p) => (
              <div key={p.title}>
                ...
                <h3 className="text-[18px] font-semibold mb-2 tracking-tight text-[#182439]">{p.title}</h3>
          ...
          <div className="flex flex-col justify-center gap-5 py-20 pl-16 pr-[max(4rem,calc((100%-80rem)/2+4rem))]">
            ...
            <ul className="space-y-3.5 mt-2">
              {[
                ...
                <li key={item} className="flex items-start gap-3 text-[14px] text-[#3b5b80] font-light">
                  <div className="mt-0.5 w-5 h-5 rounded-full bg-[#b1efec]/40 flex items-center justify-center flex-shrink-0">
                    <svg className="w-3 h-3 text-[#5ba8a3]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7" />
                    </svg>
                  </div>
                  {item}
            ...
            <div className="pt-4">
              <Link
                to="/"
                className="inline-flex items-center gap-2 bg-[#182439] text-white px-8 py-3 rounded-full font-semibold text-[15px] hover:bg-[#182439]/90 transition-colors"
              >
      ...
      <section className="custom-approach-section lg:hidden overflow-hidden">
        <div className="flex flex-col" style={{ background: "#d1ebfd" }}>
          ...
          <div className="px-6 py-12">
            ...
            <Link
              to="/"
              className="inline-flex items-center gap-2 bg-[#182439] text-white px-8 py-3.5 rounded-full font-semibold text-[15px]"
            >
              Request Employer Info
            </Link>
          </div>
      ...
      <div className="py-10 md:py-14">
        <div className="max-w-[900px] mx-auto px-6">
          <div className="text-center mb-8">
            <h2
              className="text-4xl md:text-5xl text-[#182439] tracking-tight"
              style={{ fontFamily: "var(--font-display)" }}
            >
              Insurance FAQs
            </h2>
...
function CtaSection() {
  return (
    <section className="custom-approach-section relative overflow-hidden" style={{ background: "#d1ebfd" }}>
      <div className="relative z-10 max-w-[800px] mx-auto px-6 py-24 md:py-32 text-center">
        <p className="text-[11px] font-bold tracking-[0.2em] text-[#182439] uppercase mb-6">Get Started</p>
        <h2
          className="text-[2.5rem] md:text-[3.2rem] leading-[1.08] tracking-tight mb-6 text-[#182439]"
          style={{ fontFamily: "var(--font-display)", fontWeight: 400 }}
        >
        ...
        <p className="text-[17px] text-[#3b5b80] leading-relaxed mb-10 max-w-lg mx-auto font-light">
          Enter your insurance details and we'll tell you exactly what's covered — before you commit to anything.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            to="/"
            className="bg-[#182439] hover:bg-[#182439]/90 text-white px-10 py-3.5 rounded-full font-semibold text-[15px] transition-colors"
          >
            Check My Coverage →
          </Link>
          <Link
            to="/"
            className="text-[#182439] font-semibold text-[15px] underline decoration-[#8ebfff] decoration-2 underline-offset-4 hover:decoration-[#182439] transition-colors"
          >
            Talk to billing team
          </Link>
        </div>
        <p className="mt-8 text-[#3b5b80]/50 text-[12px] font-light">
  ...
  return (
    <div className="border-b border-[#dadfe8]/50">
      <button
        ...
        type="button"
      >
        <span className="text-[16px] md:text-[17px] font-bold text-[#182439] pr-8 group-hover:text-[#5ba8a3] transition-colors leading-snug">
          {q}
        </span>
        <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-all duration-300 ${open ? "bg-[#182439]" : "bg-[#b1efec]"}`}>
          <span
            className={`material-symbols-outlined text-[18px] transition-transform duration-300 ${open ? "text-white" : "text-[#182439]"}`}
      ...
      >
        <p className="pb-7 text-[#3b5b80] leading-[1.7] text-[14.5px] pr-12 font-light">{a}</p>
      </div>
    </div>
  )
}
